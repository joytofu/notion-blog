...
const SEO = props => {
  ...
  const IMPACT_SITE_VERIFICATION = siteConfig(
        ...
        <>
          <script
              ...
              (function(){
                  ...
                  if(Math.random() < 0.05) {if (window.dataLayer && (window.dataLayer.some(e => e[0] === 'js' && e[1] instanceof Date) || window.dataLayer.some(e => e['event'] === 'gtm.js' && e['gtm.start'] == true ))) {document.head.appendChild(document.createElement('img')).src = "//clickiocdn.com/utr/gtag/?sid=243261";}}
              })();
                `
              }}
          />

          <script async type="text/javascript" src="//clickiocmp.com/t/consent_243261.js"></script>
        </>
      )
