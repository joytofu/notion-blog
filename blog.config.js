...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '196b5dc8d0748081bf3fc56741aa42c1',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Seraphina Kendra', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Your destination for unique finds in design, fashion, entertainment, and more.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://sapkr.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'fashion, crafts, DIY, design, entertainment, architecture, beauty', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Your destination for unique finds in design, fashion, entertainment, and more.',
