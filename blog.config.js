...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '13cb5dc8d07480d198b3c464c09736c2',
  PSEUDO_STATIC: process.env.NEXT_PUBLIC_PSEUDO_STATIC || true, // 伪静态路径，开启后所有文章URL都以 .html 结尾。
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 5, // 更新内容缓存间隔 单位(秒)；即每个页面有5秒的纯静态期、此期间无论多少次访问都不会抓取notion数据；调大该值有助于节省Vercel资源、同时提升访问速率，但也会使文章更新有延迟。
  THEME: process.env.NEXT_PUBLIC_THEME || 'magzine', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,magzine,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Kcswag', // 您的昵称
  BIO: process.env.NEXT_PUBLIC_BIO || 'Mastering the Art of Self-Improvement: Your Guide to Lifelong Learning', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://learninglonglife.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'self improvment, lifelong learning, learning long life, better myself, education, homeschooling, online school, well being', // 网站关键词 英文逗号隔开
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'okje3k0120', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Buddhism Zen', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'Discover the wisdom of Buddhism & Zen. Learn about the Buddha, Bodhisattva, satori, and Guanyin. Find peace and enlightenment.', // 站点描述，被notion中的页面描述覆盖
