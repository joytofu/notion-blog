...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '219b5dc8d0748035bbe5e08a14991344',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Visual Journal Craft', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://visualjournalcraft.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Visual Storytelling, Editorial Design, Magazine Layout, Photojournalism', // 网站关键词 英文逗号隔开
