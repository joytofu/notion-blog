...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '11eb5dc8d0748086bb62d90a96d5e162',
  ...
  GREETING_WORDS:
    ...
    'Buddha\'s Path to Zen 🙏',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ZenMaster', // 您的昵称
  BIO: process.env.NEXT_PUBLIC_BIO || 'Buddha\'s Path to Zen 🙏', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://buddhismzen.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'buddha, buddhism, zen, buddhism religion, bodhisattva, satori, siddhattha', // 网站关键词 英文逗号隔开
