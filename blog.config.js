...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '149b5dc8d07480018772cda9f5551409',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '丹增洛桑', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://buddhismgod.com', // 网站地址
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-W0TBMKJ7RQ', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'p3yoh1zykb', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
  ...
  NOTION_PROPERTY_NAME: {
    ...
    title: process.env.NEXT_PUBLIC_NOTION_PROPERTY_TITLE || '藏佛', // 文章标题
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '揭开藏传佛教的秘密，转动命运的齿轮', // 站点描述，被notion中的页面描述覆盖
